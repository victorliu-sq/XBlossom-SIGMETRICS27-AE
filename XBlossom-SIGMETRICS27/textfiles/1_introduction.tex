...
\begin{itemize}[leftmargin=*, topsep=0pt, itemsep=0pt, parsep=0pt]
  ...
  \item The datasets, program implementations on both CPUs and GPUs, and scripts to reproduce all experiments are open sourced for public use and continued development at \href{https://anonymous.4open.science/r/X-Blossom-GPU-CE53/}{this link}.
\end{itemize}
