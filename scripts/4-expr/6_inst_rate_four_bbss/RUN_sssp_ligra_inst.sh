...
METRICS_DIR="${PROJECT_DIR}/tmp/6_inst_rate_four_bbss/sssp_ligra"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_sssp_ligra_inst_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_6_sssp_ligra.csv"
STAMP="${RESULTS_DIR}/.stamp.table_6_sssp_ligra"
...
cp "${SUMMARY_CSV_TEMP%.csv}_samples.csv" "${RESULTS_DIR}/table_6_sssp_ligra_samples.csv"
touch "$STAMP"
