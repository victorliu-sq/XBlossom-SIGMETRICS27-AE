...
METRICS_DIR="${PROJECT_DIR}/tmp/6_inst_rate_four_bbss/multisssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_multisssp_gunrock_inst_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_6_multisssp_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_6_multisssp_gunrock"
