...
METRICS_DIR="${PROJECT_DIR}/tmp/6_inst_rate_four_bbss/sssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_sssp_gunrock_inst_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_6_sssp_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_6_sssp_gunrock"
