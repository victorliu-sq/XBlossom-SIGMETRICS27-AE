...
METRICS_DIR="${PROJECT_DIR}/tmp/6_inst_rate_four_bbss/xb_pp"
RESULTS_DIR="${PROJECT_DIR}/results/6_inst_rate_four_bbss"
STAMP="${RESULTS_DIR}/.stamp.table_6_xbpp"
ANALYZE_SCRIPT="${SCRIPT_DIR}/analyze_xb_pp_inst.sh"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_xb_pp_inst_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_6_xb_pp.csv"
SAMPLES_CSV="${RESULTS_DIR}/table_6_xb_pp_samples.csv"
