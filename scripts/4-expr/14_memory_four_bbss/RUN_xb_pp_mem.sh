...
METRICS_DIR="${PROJECT_DIR}/tmp/14_memory_four_bbss/xb_pp"
RESULTS_DIR="${PROJECT_DIR}/results/14_memory_four_bbss"
STAMP="${RESULTS_DIR}/.stamp.table_14_xbpp"
ANALYZE_SCRIPT="${SCRIPT_DIR}/analyze_xb_pp_mem.sh"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_xb_pp_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_14_xb_pp.csv"
SAMPLES_CSV="${RESULTS_DIR}/table_14_xb_pp_samples.csv"
