...
METRICS_DIR="${PROJECT_DIR}/tmp/14_memory_four_bbss/bfs_ligra"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_bfs_ligra_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_14_bfs_ligra.csv"
STAMP="${RESULTS_DIR}/.stamp.table_14_bfs_ligra"
...
cp "${SUMMARY_CSV_TEMP%.csv}_samples.csv" "${RESULTS_DIR}/table_14_bfs_ligra_samples.csv"
touch "$STAMP"
