...
METRICS_DIR="${PROJECT_DIR}/tmp/14_memory_four_bbss/xb_pro"
RESULTS_DIR="${PROJECT_DIR}/results/14_memory_four_bbss"
STAMP="${RESULTS_DIR}/.stamp.table_14_xbpro"
ANALYZE_SCRIPT="${SCRIPT_DIR}/analyze_xb_pro_mem.sh"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_xb_pro_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_14_xb_pro.csv"
SAMPLES_CSV="${RESULTS_DIR}/table_14_xb_pro_samples.csv"
