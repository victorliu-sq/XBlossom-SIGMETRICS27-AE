...
METRICS_DIR="${PROJECT_DIR}/tmp/14_memory_four_bbss/bfs_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_bfs_gunrock_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_14_bfs_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_14_bfs_gunrock"
