...
METRICS_DIR="${PROJECT_DIR}/tmp/8_memory_four_bbss/multisssp_ligra"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_multisssp_ligra_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_8_multisssp_ligra.csv"
STAMP="${RESULTS_DIR}/.stamp.table_8_multisssp_ligra"
...
cp "${SUMMARY_CSV_TEMP%.csv}_samples.csv" "${RESULTS_DIR}/table_8_multisssp_ligra_samples.csv"
touch "$STAMP"
