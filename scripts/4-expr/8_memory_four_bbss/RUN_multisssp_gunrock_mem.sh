...
METRICS_DIR="${PROJECT_DIR}/tmp/8_memory_four_bbss/multisssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_multisssp_gunrock_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_8_multisssp_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_8_multisssp_gunrock"
