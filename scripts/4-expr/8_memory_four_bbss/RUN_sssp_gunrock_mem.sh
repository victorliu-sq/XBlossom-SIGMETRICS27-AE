...
METRICS_DIR="${PROJECT_DIR}/tmp/8_memory_four_bbss/sssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_sssp_gunrock_mem_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_8_sssp_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_8_sssp_gunrock"
