...
METRICS_DIR="${PROJECT_DIR}/tmp/6_runtime_four_bbss/multisssp_ligra"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_multisssp_ligra_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_6_multisssp_ligra.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_6_multisssp_ligra_samples.csv"
STAMP="${RESULTS_DIR}/.stamp.figure_6_multisssp_ligra"
