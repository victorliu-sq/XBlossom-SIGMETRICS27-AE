...
METRICS_DIR="${PROJECT_DIR}/tmp/6_runtime_four_bbss/bfs_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_bfs_gunrock_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_6_bfs_gunrock.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_6_bfs_gunrock_samples.csv"
STAMP="${RESULTS_DIR}/.stamp.figure_6_bfs_gunrock"
ROUNDS="${ROUNDS:-20}"
