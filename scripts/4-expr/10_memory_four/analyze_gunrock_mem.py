...
effective_memory_bandwidth   = total_bytes / runtime / 1e9
...
with open(summary_out, "a", newline="") as csvfile:
    ...
    writer.writerow([
        ...
        f"{effective_memory_bandwidth:.3f}"
    ])
...
print(f"  Effective Memory Bandwidth:   {effective_memory_bandwidth:.3f} GB/s\n")
