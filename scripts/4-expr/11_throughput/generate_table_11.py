...
bc_ligra = read_table(args.bc_ligra_csv)
bc_gunrock = read_table(args.bc_gunrock_csv)
...
for dataset in datasets:
    ...
    append_algorithm_columns(row, "BC", "BC-Ligra", "BC-Gunrock", bc_ligra, bc_gunrock, dataset)
...
print(f"Table-11 CSV generated at: {output}")
