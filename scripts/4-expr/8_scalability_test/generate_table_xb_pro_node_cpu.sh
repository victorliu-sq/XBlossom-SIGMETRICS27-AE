...
METRICS_DIR="${PROJECT_DIR}/tmp/8_scalability_test/xb_pro_node_cpu"
OUTPUT_TEX="${PROJECT_DIR}/results/8_scalability_test/tab_xb_pro_node_cpu_scalability_ci.tex"
