...
METRICS_DIR="${PROJECT_DIR}/tmp/16_scalability_test/xb_pp_node_gpu_sm"
OUTPUT_TEX="${PROJECT_DIR}/results/16_scalability_test/tab_xb_pp_node_gpu_sm_scalability_ci.tex"
GPU_SMS="${GPU_SMS:-188}"
