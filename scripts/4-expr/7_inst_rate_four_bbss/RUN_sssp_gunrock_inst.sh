...
METRICS_DIR="${PROJECT_DIR}/tmp/7_inst_rate_four_bbss/sssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_sssp_gunrock_inst_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_7_sssp_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_7_sssp_gunrock"
