...
METRICS_DIR="${PROJECT_DIR}/tmp/7_inst_rate_four_bbss/bfs_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_bfs_gunrock_inst_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/table_7_bfs_gunrock.csv"
STAMP="${RESULTS_DIR}/.stamp.table_7_bfs_gunrock"
