...
METRICS_DIR="${PROJECT_DIR}/tmp/5_runtime_four_bbss/multisssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_multisssp_gunrock_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_5_multisssp_gunrock.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_5_multisssp_gunrock_samples.csv"
STAMP="${RESULTS_DIR}/.stamp.figure_5_multisssp_gunrock"
ROUNDS="${ROUNDS:-20}"
