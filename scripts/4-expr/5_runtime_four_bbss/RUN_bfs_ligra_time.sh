...
METRICS_DIR="${PROJECT_DIR}/tmp/5_runtime_four_bbss/bfs_ligra"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_bfs_ligra_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_5_bfs_ligra.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_5_bfs_ligra_samples.csv"
STAMP="${RESULTS_DIR}/.stamp.figure_5_bfs_ligra"
