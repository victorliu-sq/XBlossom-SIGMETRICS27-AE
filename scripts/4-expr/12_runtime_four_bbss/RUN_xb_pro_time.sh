...
METRICS_DIR="${PROJECT_DIR}/tmp/12_runtime_four_bbss/xb_pro"
RESULTS_DIR="${PROJECT_DIR}/results/12_runtime_four_bbss"
STAMP="${RESULTS_DIR}/.stamp.figure_12_xbpro"
ANALYZE_SCRIPT="${SCRIPT_DIR}/analyze_xb_pro_time.sh"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_xb_pro_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_12_xb_pro.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_12_xb_pro_samples.csv"
