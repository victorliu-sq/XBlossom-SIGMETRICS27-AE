...
METRICS_DIR="${PROJECT_DIR}/tmp/12_runtime_four_bbss/bfs_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_bfs_gunrock_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_12_bfs_gunrock.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_12_bfs_gunrock_samples.csv"
STAMP="${RESULTS_DIR}/.stamp.figure_12_bfs_gunrock"
ROUNDS="${ROUNDS:-20}"
