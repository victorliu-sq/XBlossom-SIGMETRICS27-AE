...
METRICS_DIR="${PROJECT_DIR}/tmp/12_runtime_four_bbss/sssp_gunrock"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_sssp_gunrock_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_12_sssp_gunrock.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_12_sssp_gunrock_samples.csv"
STAMP="${RESULTS_DIR}/.stamp.figure_12_sssp_gunrock"
ROUNDS="${ROUNDS:-20}"
