...
METRICS_DIR="${PROJECT_DIR}/tmp/12_runtime_four_bbss/xb_pp"
RESULTS_DIR="${PROJECT_DIR}/results/12_runtime_four_bbss"
STAMP="${RESULTS_DIR}/.stamp.figure_12_xbpp"
ANALYZE_SCRIPT="${SCRIPT_DIR}/analyze_xb_pp_time.sh"
SUMMARY_CSV_TEMP="${METRICS_DIR}/_xb_pp_summary.csv"
SUMMARY_CSV="${RESULTS_DIR}/figure_12_xb_pp.csv"
SAMPLES_CSV="${RESULTS_DIR}/figure_12_xb_pp_samples.csv"
ROUNDS="${ROUNDS:-20}"
