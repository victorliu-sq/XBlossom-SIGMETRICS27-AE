...
PYTHON_SCRIPT="expr/xb_pro/RUN_xb_pro_all_datasets_intel_inst_llc_count_cycles_analysis.py"
...
for DATASET in "${DATASETS[@]}"; do
  ...
  ROUNDS=10   # You can later change this and Python will respect it
