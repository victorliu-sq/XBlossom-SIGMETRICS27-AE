...
XB_PRO_BIN="build/bin/run_xb_pro_pernode_nb_by_dataset"
METRICS_DIR="tmp/xb_pro_nb_metrics"
PYTHON_SCRIPT="expr/xb_pro/RUN_xb_pro_nb_all_datasets_intel_inst_llc_count_analysis.py"
SUMMARY_CSV="$METRICS_DIR/_xb_pro_nb_summary.csv"
...
for DATASET in "${DATASETS[@]}"; do
  ...
  TIMING_OUT="$METRICS_DIR/xb_pro_nb_${DATASET}_timing.txt"
  PROFILER_OUT="$METRICS_DIR/xb_pro_nb_${DATASET}_profiling.txt"
