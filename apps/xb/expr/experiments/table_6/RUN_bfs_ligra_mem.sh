...
METRICS_DIR="tmp/bfs_ligra_metrics_mem"
RESULTS_DIR="data/results"
STAMP="${RESULTS_DIR}/.stamp.table_6_ligra"
PYTHON_SCRIPT="expr/experiments/table_6/RUN_bfs_ligra_mem.py"
...
#AGGREGATE_CSV="$METRICS_DIR/_bfs_ligra_aggregated_summary.csv"
...
if [ -f "$STAMP" ]; then
  echo "✅ Table 6 Ligra Part already generated (stamp found)"
  exit 0
fi
