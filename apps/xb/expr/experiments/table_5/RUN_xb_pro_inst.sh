...
METRICS_DIR="tmp/xb_pro_inst"
RESULTS_DIR="data/results"
STAMP="${RESULTS_DIR}/.stamp.table_5_xbpro"
PYTHON_SCRIPT="expr/experiments/table_5/RUN_xb_pro_inst.py"
SUMMARY_CSV_TEMP="$METRICS_DIR/_xb_pro_summary.csv"
SUMMARY_CSV="$RESULTS_DIR/table_5_xb_pro.csv"
...
if [ -f "$STAMP" ]; then
  echo "✅ Table 5 XB-Pro Part already generated (stamp found)"
  exit 0
fi
