...
XB_PRO_BIN="build/bin/run_xb_pro_pernode_by_dataset"
METRICS_DIR="tmp/xb_pro_node_level_inst"
RESULTS_DIR="data/results"
STAMP="${RESULTS_DIR}/.stamp.figure_7_node"

PYTHON_SCRIPT="expr/experiments/figure_7/RUN_xb_pro_inst_node.py"
SUMMARY_CSV_TEMP="$METRICS_DIR/_xb_pro_summary.csv"
SUMMARY_CSV="$RESULTS_DIR/figure_7_node.csv"
...
if [ -f "$STAMP" ]; then
  echo "✅ Figure 7 Node Part already generated (stamp found)"
  exit 0
fi
