...
# --- Configuration ---
LIGRA_BIN="./third_party/ligra/apps/BFSCC"
METRICS_DIR="tmp/ligra_cc_metrics_llc"
PYTHON_SCRIPT="expr/ligra/RUN_ligra_cc_all_datasets_intel_analyze.py"
SUMMARY_CSV="$METRICS_DIR/_ligra_cc_summary.csv"

# New Configuration for Aggregation
#AGGREGATE_SCRIPT="expr/ligra/aggregate_ligra_profile_rand_src.py"
#AGGREGATE_CSV="$METRICS_DIR/_ligra_cc_aggregated_summary.csv"
