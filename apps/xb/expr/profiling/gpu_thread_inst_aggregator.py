...
if len(sys.argv) < 3:
    print("Usage: python3 gpu_thread_inst_aggregator.py <ncu_output.csv> <summary_file>")
    sys.exit(1)
...
with open(filename, newline='') as f:
    ...
    for row in reader:
        ...
        if metric == "sm__sass_thread_inst_executed.sum":
...
result_text = (
    ...
    f"  Total Thread Instructions Executed: {total_insts}\n"
