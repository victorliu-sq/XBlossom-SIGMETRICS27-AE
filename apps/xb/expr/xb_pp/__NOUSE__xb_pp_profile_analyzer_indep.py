...
if len(sys.argv) != 6:
    print("Usage: xb_pp_profile_analyzer.py <dataset> <timing_file> <profiling_file_1> <profiling_file_2> <summary_out>")
    print("Example: python3 xb_pp_profile_analyzer.py Amazon xb_pp_timing_Amazon.txt xb_pp_profile_Amazon_1.csv xb_pp_profile_Amazon_2.csv _xb_pp_summary_Amazon.csv")
    sys.exit(1)
