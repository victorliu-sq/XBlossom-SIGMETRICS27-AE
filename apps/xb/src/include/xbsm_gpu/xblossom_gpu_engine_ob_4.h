#ifndef XBLOSSOM_GPU_ENGINE_OB_4_H
#define XBLOSSOM_GPU_ENGINE_OB_4_H
...
namespace zblossom {
  class XBlossomGpuEngineOb4 : public SecondaryMaximumMatchingGPUEngine {
    // template<typename XBlossomEngine>
    friend class XbsmGpuEngineTester<XBlossomGpuEngineOb4>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngineOb4(ParBlossom)";
    }

    XBlossomGpuEngineOb4() = delete;

    XBlossomGpuEngineOb4(const HGraph &g);

    XBlossomGpuEngineOb4(const HGraph &g, size_t path_table_buffer_ratio);
...
#endif //XBLOSSOM_GPU_ENGINE_OB_4_H
