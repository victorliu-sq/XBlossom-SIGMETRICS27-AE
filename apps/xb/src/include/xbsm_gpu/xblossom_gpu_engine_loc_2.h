#ifndef XBLOSSOM_GPU_ENGINE_LOC_2_H
#define XBLOSSOM_GPU_ENGINE_LOC_2_H
...
namespace zblossom {
  class XBlossomGpuEngineLoc2 : public SecondaryMaximumMatchingGPUEngine {
    // template<typename XBlossomEngine>
    friend class XbsmGpuEngineTester<XBlossomGpuEngineLoc2>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngineLoc2(Locality)";
    }

    XBlossomGpuEngineLoc2() = delete;

    XBlossomGpuEngineLoc2(const HGraph &g);
...
#endif //XBLOSSOM_GPU_ENGINE_LOC_2_H
