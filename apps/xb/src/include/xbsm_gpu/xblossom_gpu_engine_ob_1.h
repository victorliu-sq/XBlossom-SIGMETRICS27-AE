#ifndef XBLOSSOM_GPU_ENGINE_OB_1_H
#define XBLOSSOM_GPU_ENGINE_OB_1_H
...
namespace zblossom {
  class XBlossomGpuEngineOb1 : public SecondaryMaximumMatchingGPUEngine {
    // template<typename XBlossomEngine>
    friend class XbsmGpuEngineTester<XBlossomGpuEngineOb1>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngineOb1(Locality)";
    }

    XBlossomGpuEngineOb1() = delete;

    XBlossomGpuEngineOb1(const HGraph &g);
...
#endif //XBLOSSOM_GPU_ENGINE_OB_1_H
