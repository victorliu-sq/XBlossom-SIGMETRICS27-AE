#ifndef XBLOSSOM_GPU_ENGINE_OB_5_H
#define XBLOSSOM_GPU_ENGINE_OB_5_H
...
namespace zblossom {
  class XBlossomGpuEngineOb5 : public SecondaryMaximumMatchingGPUEngine {
    // template<typename XBlossomEngine>
    friend class XbsmGpuEngineTester<XBlossomGpuEngineOb5>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngineOb5(ParTransformOddNodes)";
    }

    XBlossomGpuEngineOb5() = delete;

    XBlossomGpuEngineOb5(const HGraph &g);

    XBlossomGpuEngineOb5(const HGraph &g, size_t path_table_buffer_ratio);
...
#endif //XBLOSSOM_GPU_ENGINE_OB_5_H
