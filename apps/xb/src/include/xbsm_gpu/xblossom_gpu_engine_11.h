#ifndef XBLOSSOM_GPU_ENGINE_11_H
#define XBLOSSOM_GPU_ENGINE_11_H
...
namespace zblossom {
  class XBlossomGpuEngine11 : public SecondaryMaximumMatchingGPUEngine {
    // template<typename XBlossomEngine>
    friend class XbsmGpuEngineTester<XBlossomGpuEngine11>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngine11(Reuse+ParBlossom+Sorting)";
    }

    XBlossomGpuEngine11() = delete;

    XBlossomGpuEngine11(const HGraph &g);

    XBlossomGpuEngine11(const HGraph &g, size_t path_table_buffer_ratio);
...
#endif //XBLOSSOM_GPU_ENGINE_11_H
