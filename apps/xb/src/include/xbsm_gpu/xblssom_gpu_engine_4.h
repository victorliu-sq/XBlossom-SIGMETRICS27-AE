#ifndef XBLSSOM_GPU_ENGINE_4_H
#define XBLSSOM_GPU_ENGINE_4_H
...
namespace zblossom {
  class XBlossomGpuEngine4 : public SecondaryMaximumMatchingGPUEngine {
    // template<typename XBlossomEngine>
    friend class XbsmGpuEngineTester<XBlossomGpuEngine4>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngine4(Locality)";
    }

    XBlossomGpuEngine4() = delete;

    XBlossomGpuEngine4(const HGraph &g);
