#ifndef XBLOSSOM_GPU_ENGINE_3_H
#define XBLOSSOM_GPU_ENGINE_3_H
...
namespace zblossom {
  class XBlossomGpuEngine3 : public SecondaryMaximumMatchingGPUEngine {
    friend class XBlossomGpuEngineTester;
    friend class XBlossomGpuEngineParEdgeTester;
    friend class XbsmGpuEngineTester<XBlossomGpuEngine3>;

  public:
    static inline String EngineName() {
      return "XBlossomGpuEngine3(OptimizedBlossom)";
    }

    XBlossomGpuEngine3() = delete;

    XBlossomGpuEngine3(const HGraph &g);
