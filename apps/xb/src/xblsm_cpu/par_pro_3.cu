...
namespace xblossom {
  ...
  void parFindMaximumMatchingNoRecursionUpdatePathTable_pro_3(Graph &G, std::vector<int> &M, bool &valid_M,
                                                              int &threshold) {
    bool finished = false;
    ...
    while (!finished) {
      ...
      parFindAugmentingPathNoRecursionUpdatePathTable_pro_3(G, M, path_collection, path_table_vector);
  ...
  void parAugmentingPath_pro_3(const std::vector<int> &rowOffsets,
  ...
  void parExpand_pro_3(const std::vector<int> &rowOffsets,
                       const std::vector<int> &columnIndices,
                       const std::vector<int> &nodes_vector,
                       int index, int num_threads, std::vector<int> &is_even, std::vector<int> &belongs,
  ...
  //
  //   // 2. Compute the root distance of v, w, blossom base
  //
  //   // 3. resize blossom
  // }
  ...
  void parBlossom_pro_3(const std::vector<int> &rowOffsets,
                        const std::vector<int> &columnIndices,
                        const std::vector<int> &nodes_vector,
                        int index, int num_threads, std::vector<int> &is_even, std::vector<int> &belongs,
  ...
  void parFindAugmentingPathNoRecursionUpdatePathTable_pro_3(Graph &G, std::vector<int> &M,
                                                             std::vector<std::vector<int> > &path_collection,
                                                             std::vector<std::vector<int> > &path_table_vector) {
    ...
    while (!check_all) {
      ...
      for (int begin = 0; begin < num_of_threads; begin++) {
        threads.emplace_back(parAugmentingPath_pro_3,
      ...
      for (int begin = 0; begin < num_of_threads; begin++) {
        threads.emplace_back(parExpand_pro_3,
                             std::ref(G.rowOffsets),
                             std::ref(G.columnIndices),
                             std::ref(nodes_vector),
                             begin,
      ...
      for (int begin = 0; begin < num_of_threads; begin++) {
        threads.emplace_back(parBlossom_pro_3, std::ref(G.rowOffsets), std::ref(G.columnIndices),
                             std::ref(nodes_vector),
