#include "xbsm_gpu/xblossom_gpu_engine_2.h"
#include <glog/logging.h>
#include "utils/cuda_algo.h"
#include "common/stopwatch.h"

namespace zblossom {
  XBlossomGpuEngine2::XBlossomGpuEngine2(const HGraph &g)
  ...
  XBlossomGpuEngine2::XBlossomGpuEngine2(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
  ...
  void XBlossomGpuEngine2::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngine2::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngine2::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngine2::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngine2::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
