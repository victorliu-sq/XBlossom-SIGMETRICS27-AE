#include "xbsm_gpu/xblossom_gpu_engine_ob_3.h"
#include <glog/logging.h>
#include "utils/cuda_algo.h"

namespace zblossom {
  XBlossomGpuEngineOb3::XBlossomGpuEngineOb3(const HGraph &g)
  ...
  XBlossomGpuEngineOb3::XBlossomGpuEngineOb3(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
      ...
      // For ParBlossom
      // 50 for Hyperlink
      blossom_offset_list_(50 * nnodes_ + 1),
      num_nodes_in_blossom_list_(50 * nnodes_ + 1),
      num_odd_nodes_in_blossom_list_(50 * nnodes_ + 1),
      num_odd_nodes_in_blossom_psum_(50 * nnodes_ + 1) {
  }

  void XBlossomGpuEngineOb3::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngineOb3::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngineOb3::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngineOb3::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineOb3::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
