...
#include "xbsm_gpu/xblssom_gpu_engine_4.h"
#include "utils/cuda_algo.h"

namespace zblossom {
  XBlossomGpuEngine4::XBlossomGpuEngine4(const HGraph &g)
  ...
  void XBlossomGpuEngine4::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngine4::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngine4::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngine4::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  bool XBlossomGpuEngine4::AugPathAndExpand() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngine4::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
  ...
  bool XBlossomGpuEngine4::AugPathAndExpandAndBlossom() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngine4::ExpandAndBlossom() {
    auto start_time = getNanoSecond();
