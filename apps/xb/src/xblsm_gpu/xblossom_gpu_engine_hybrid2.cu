...
#include "xbsm_gpu/xblossom_gpu_engine_hybrid2.h"

namespace zblossom {
  XBlossomGpuEngineHybrid2::XBlossomGpuEngineHybrid2(const HGraph &g)
...
#define ODD_NODE_RATIO 30
  ...
  XBlossomGpuEngineHybrid2::XBlossomGpuEngineHybrid2(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
  ...
  void XBlossomGpuEngineHybrid2::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngineHybrid2::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngineHybrid2::FindAndFlipAugmentingPathInAlternatingForest() {
    ...
    if (total_even_nodes > LOAD_BALANCING_THRESHOLD_) {
      ...
      // ========================================================================================================
      // Edge-Level
      this->ExecuteNTasklets(total_num_pairs, [=] __device__ (index_t tid) mutable {
  ...
  void XBlossomGpuEngineHybrid2::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineHybrid2::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
