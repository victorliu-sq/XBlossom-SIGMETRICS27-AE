...
#include "xbsm_gpu/xblossom_gpu_engine_hybrid.h"

namespace zblossom {
  XBlossomGpuEngineHybrid::XBlossomGpuEngineHybrid(const HGraph &g)
...
#define ODD_NODE_RATIO 30
  ...
  XBlossomGpuEngineHybrid::XBlossomGpuEngineHybrid(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
  ...
  void XBlossomGpuEngineHybrid::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngineHybrid::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngineHybrid::FindAndFlipAugmentingPathInAlternatingForest() {
    ...
    if (total_num_pairs > LOAD_BALANCING_THRESHOLD_) {
      // ========================================================================================================
      // Edge-Level
  ...
  void XBlossomGpuEngineHybrid::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineHybrid::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
