#include "xbsm_gpu/xblossom_gpu_engine_p_1.h"
...
namespace zblossom {
  XBlossomGpuEngineP1::XBlossomGpuEngineP1(const HGraph &g)
  ...
  XBlossomGpuEngineP1::XBlossomGpuEngineP1(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
  ...
  void XBlossomGpuEngineP1::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngineP1::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngineP1::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngineP1::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineP1::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
...

    {
      ...
      KTransformOddNodesInBlossomPairs<<<GRID, BLOCK>>>(
        total_num_pairs,
        enode_base_offset,
        (index_t) total_even_nodes,
        (index_t) nnodes,
