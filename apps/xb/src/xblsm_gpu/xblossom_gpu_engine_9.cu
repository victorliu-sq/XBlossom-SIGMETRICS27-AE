#include "xbsm_gpu/xblossom_gpu_engine_9.h"
#include <glog/logging.h>
#include "xbsm_gpu/kernels.h"
#include "utils/cuda_algo.h"

namespace zblossom {
  XBlossomGpuEngine9::XBlossomGpuEngine9(const HGraph &g)
...
// #define ODD_NODE_RATIO 10
  ...
  XBlossomGpuEngine9::XBlossomGpuEngine9(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
  ...
  void XBlossomGpuEngine9::FindAndFlipAugmentingPath() {
  ...
  // void XBlossomGpuEngine9::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngine9::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngine9::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngine9::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
