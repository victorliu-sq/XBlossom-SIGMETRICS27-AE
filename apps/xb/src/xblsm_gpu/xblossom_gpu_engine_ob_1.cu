#include "xbsm_gpu/xblossom_gpu_engine_ob_1.h"
...
namespace zblossom {
  XBlossomGpuEngineOb1::XBlossomGpuEngineOb1(const HGraph &g)
  ...
  void XBlossomGpuEngineOb1::FindAndFlipAugmentingPath() {
  ...
  void XBlossomGpuEngineOb1::InitAlternatingForest() {
  ...
  bool XBlossomGpuEngineOb1::FindAndFlipAugmentingPathInAlternatingForest() {
    ...
    LOG(INFO) << "[AugPath] Total Number of Nodes: " << total_even_nodes;
    LOG(INFO) << "[AugPath] Total Number of Edges : " << total_num_pairs;
  ...
  void XBlossomGpuEngineOb1::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineOb1::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
