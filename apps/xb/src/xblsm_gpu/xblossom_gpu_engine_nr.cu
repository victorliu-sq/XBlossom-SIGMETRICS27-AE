...
#include "xbsm_gpu/xblossom_gpu_engine_nr.h"

namespace zblossom {
  XBlossomGpuEngineNR::XBlossomGpuEngineNR(const HGraph &g)
...
#define ODD_NODE_RATIO 30
  ...
  XBlossomGpuEngineNR::XBlossomGpuEngineNR(const HGraph &g, size_t path_table_buffer_ratio)
    : SecondaryMaximumMatchingGPUEngine(g.nnodes),
      // host_graph_(g),
      device_graph_(g),
  ...
  void XBlossomGpuEngineNR::FindAndFlipAugmentingPath() {
  ...
  // =====================================================================================================
  // Reuse
  // void XBlossomGpuEngineNR::InitAlternatingForest() {
  ...
  void XBlossomGpuEngineNR::InitAlternatingForest() {
    ...
    // Find all exposed nodes
    CUDA_CHECK(cudaDeviceSynchronize());
    this->ExecuteNTasklets(nnodes_, [=] __device__ (index_t idx) mutable {
  ...
  bool XBlossomGpuEngineNR::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngineNR::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineNR::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
