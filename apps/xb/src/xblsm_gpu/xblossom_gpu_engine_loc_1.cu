...
#include "xbsm_gpu/xblossom_gpu_engine_loc_1.h"
#include "utils/cuda_algo.h"

namespace zblossom {
  XBlossomGpuEngineLoc1::XBlossomGpuEngineLoc1(const HGraph &g)
  ...
  void XBlossomGpuEngineLoc1::FindAndFlipAugmentingPath() {
    iterations++;
  ...
  void XBlossomGpuEngineLoc1::InitAlternatingForest() {
  ...
  // bool XBlossomGpuEngineLoc1::FindAndFlipAugmentingPathInAlternatingForest() {
  ...
  void XBlossomGpuEngineLoc1::ExpandAlternatingForest() {
    auto start_time = getNanoSecond();
  ...
  bool XBlossomGpuEngineLoc1::AugPathAndExpand() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineLoc1::TransformOddNodesInBlossom() {
    auto start_time = getNanoSecond();
  ...
  bool XBlossomGpuEngineLoc1::AugPathAndExpandAndBlossom() {
    auto start_time = getNanoSecond();
  ...
  void XBlossomGpuEngineLoc1::ExpandAndBlossom() {
    auto start_time = getNanoSecond();
